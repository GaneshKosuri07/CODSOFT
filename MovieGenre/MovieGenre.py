...
df_test = pd.read_csv(r'C:\Users\kosur\Downloads\test_data.csv', low_memory=False)
df_solution = pd.read_csv(r'C:\Users\kosur\Downloads\test_data_solution.csv', low_memory=False)
df_train = pd.read_csv(r'c:\Users\kosur\Downloads\train_data.csv', low_memory=False)
